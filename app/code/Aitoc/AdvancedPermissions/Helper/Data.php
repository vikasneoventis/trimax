...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return (bool)$this->getRole()->getScope();
    }
     ...
     * Get Role
     *
     * @return \Aitoc\AdvancedPermissions\Model\Role
     */
    public function getRole()
    {
        if (!$this->role
            ...
            $this->role = ObjectManager::getInstance()->get('Aitoc\AdvancedPermissions\Model\Role')
                ->loadOriginal($roleId);
        }
