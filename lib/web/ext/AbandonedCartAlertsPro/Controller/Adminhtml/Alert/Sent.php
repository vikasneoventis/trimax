...
/**
 * Class Sent
 * @package Aitoc\AbandonedCartAlertsPro\Controller\Adminhtml\Alert
 */
class Sent extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $output = $resultLayout->getLayout()
            ->getBlock(
                'aitocabandonedcart.extension.index.tab.alert.sent'
            )
            ->toHtml();
