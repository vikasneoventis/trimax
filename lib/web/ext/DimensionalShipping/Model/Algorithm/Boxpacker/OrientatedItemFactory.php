...
class OrientatedItemFactory implements LoggerAwareInterface
{
    ...
    public function getBestOrientation(
        ...
        $possibleOrientations = $this->getPossibleOrientations($item, $widthLeft, $lengthLeft, $depthLeft, $prevItem);
    ...
    public function getPossibleOrientations(
        ...
        if ($prevItem && $prevItem->getItem() == $item) {
            $orientations[] = new OrientatedItem(
                $item,
                $prevItem->getWidth(),
                $prevItem->getLength(),
                $prevItem->getDepth()
        ...
        return array_filter(
            $orientations,
            function (OrientatedItem $i) use ($widthLeft, $lengthLeft, $depthLeft) {
