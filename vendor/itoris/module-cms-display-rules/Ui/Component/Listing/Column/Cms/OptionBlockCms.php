...
class OptionBlockCms extends AbstractOption
{
    public function toOptionArray()
    {
        $cmsBlockCollection = $this->getObjectManager()->create('Magento\Cms\Model\ResourceModel\Block\Collection');
        ...
        array_unshift($cmsBlocks, array(
            'label' => $this->escapeHtml(__('No block, show nothing')),
            'value' => 0,
        ));
        return $cmsBlocks;
    }
